var welcome = {
    ...
    begin : function(){
        var $this = this;
        $this.configs = parent.document.app.configs;
        $this.start();
    },
    ...
    start : function(){
        ...
        this.device = {};
        this.device.type = "pc";//window.innerWidth>980?"pc":window.innerWidth>500?"tablette":"mobile";
        ...
        document.body.onload = function(){
            ...
            $this.init();
            platform.init($this);
            parent.document.app.win.maximize();
        };
    },
    ...
    init : function(){
        ...
        var electronWindowLeftControl = parent.document.getElementById("ms-app-window-button-control-left");
        var electronWindowRightControl = parent.document.getElementById("ms-app-window-button-control-right");
        if(electronWindowLeftControl){
            electronWindowLeftControl.addEventListener("click", function(){
                msTheme.swiper.slidePrev();
            });
        }
        if(electronWindowRightControl){
            electronWindowRightControl.addEventListener("click", function(){
                msTheme.swiper.slideNext();
            });
        }
    },
    ...
    closeWindowsLoader : function(){
        ...
        window.setTimeout(function(){
            $(".loader-page").animate({'margin-left': '-150%'}, "fast",function(){
                ...
                parent.document.app.splashcreen.style.display = "none";
                parent.document.app.windowsContentPages.style.display = "block";
            }); 
        }, 200);
    },
